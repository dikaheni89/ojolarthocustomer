// import 'package:skydemo_gym/localization/locale_constant.dart';
import 'package:intl/intl.dart';

import 'multiselectdialog/multiselect_dialog.dart';
...
class Constant {
  ...
  static List<MultiSelectDialogItem> daysList = [
    MultiSelectDialogItem(
        "1", DateFormat.EEEE().dateSymbols.WEEKDAYS[1]),
    MultiSelectDialogItem(
        "2", DateFormat.EEEE().dateSymbols.WEEKDAYS[2]),
    MultiSelectDialogItem(
        "3", DateFormat.EEEE().dateSymbols.WEEKDAYS[3]),
    MultiSelectDialogItem(
        "4", DateFormat.EEEE().dateSymbols.WEEKDAYS[4]),
    MultiSelectDialogItem(
        "5", DateFormat.EEEE().dateSymbols.WEEKDAYS[5]),
    MultiSelectDialogItem(
        "6", DateFormat.EEEE().dateSymbols.WEEKDAYS[6]),
    MultiSelectDialogItem(
        "7", DateFormat.EEEE().dateSymbols.WEEKDAYS[0]),
  ];
  static const String emailPath = 'sahidrahutomo@gmail.com';

  static String shareLink = "Add your app link here";

  static String getPrivacyPolicyURL() {
    return "https://skytech.web.id/public/privacy/index.html";
  }
