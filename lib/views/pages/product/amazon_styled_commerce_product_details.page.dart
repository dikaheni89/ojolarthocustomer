                ...
                VStack(
                  [
                    ...
                    Visibility(
                      ...
                      child: HStack(
                        [
                          "Was:".tr().text.coolGray700.make(),
                          UiSpacer.hSpace(4),
                          rupiah(model.product.price).text
                              .color(AppColor.primaryColor)
                              .size(14)
                              .semiBold
                              .make()
                    ...
                    HStack(
                      [
                        "Price:".tr().text.coolGray700.make(),
                        UiSpacer.hSpace(4),
                        rupiah(model.product.sellPrice).text
                            .color(AppColor.primaryColor)
                            .size(18)
                            .bold
                            .make()
                    ...
                    CustomVisibilty(
                      ...
                      child: VStack(
                        [
                          ...
                          UiSpacer.vSpace(15),
                          //add to cart
                          AddToCartButton(model).wFull(context),
                          UiSpacer.vSpace(10),
                          //buy now
                          BuyNowButton(model).wFull(context),
                        ],
                      ),
                    ),
                    //no stock
