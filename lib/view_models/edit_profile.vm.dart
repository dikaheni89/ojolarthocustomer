...
class EditProfileViewModel extends MyBaseViewModel {
  ...
  processUpdate() async {
    //
    print(phoneTEC.text);
    if(selectedCountry.phoneCode == "62"){
      phoneTEC.text = phoneTEC.text.replaceAll("-", "");
      if(phoneTEC.text.startsWith("0")){
        phoneTEC.text = phoneTEC.text.substring(1, phoneTEC.text.length);
        print(phoneTEC);
      }
    }
