...
import 'package:fuodz/database/tables/discover_plan_table.dart';
import 'package:fuodz/database/tables/fullbody_workout_table.dart';
import 'package:fuodz/database/tables/history_table.dart';
import 'package:fuodz/database/tables/history_week_data.dart';
import 'package:fuodz/database/tables/home_plan_table.dart';
import 'package:fuodz/database/tables/reminder_table.dart';
import 'package:fuodz/database/tables/weight_table.dart';
import 'package:sqflite/sqflite.dart';
import 'package:path/path.dart' as path;
import 'dart:io' as io;

import '../constants/constant.dart';
import 'model/DiscoverSingleExerciseData.dart';
import 'model/ExerciseListData.dart';
import 'model/WeekDayData.dart';
import 'model/WeeklyDayData.dart';
...
class DataBaseHelper {
  ...
  Future<List<ReminderTable>> getReminderData() async {
    ...
    var dbClient = await db;
    // print(reminderTable);
    List<Map<String, dynamic>> maps = await dbClient.rawQuery("SELECT * FROM $reminderTable");
    if (maps.length > 0) {
      for (var answer in maps) {
