...
import '../views/pages/pharmacy/gym/discover/DiscoverScreen.dart';
import '../views/pages/pharmacy/gym/introduction/IntroductionScreen.dart';
import '../views/pages/pharmacy/gym/reminder/reminder_screen.dart';
import '../views/pages/pharmacy/gym/report/report_screen.dart';
import '../views/pages/pharmacy/gym/training_plan/training_screen.dart';
import '../views/pages/pharmacy/gym/workoutComplete/workout_complete_screen.dart';
...
Route<dynamic> generateRoute(RouteSettings settings) {
  switch (settings.name) {
    ...
    case AppRoutes.training:
      return MaterialPageRoute(
        settings: RouteSettings(
            name: AppRoutes.training, arguments: Map()),
    ...
    case AppRoutes.discover:
      return MaterialPageRoute(
          settings: RouteSettings(
              name: AppRoutes.discover, arguments: Map()),
    ...
    case AppRoutes.report:
      return MaterialPageRoute(
          settings: RouteSettings(
              name: AppRoutes.report, arguments: Map()),
    ...
    //   return MaterialPageRoute(
    //       settings: RouteSettings(
    //           name: AppRoutes.settings, arguments: Map()),
    ...
    case AppRoutes.reminder:
      return MaterialPageRoute(
          settings: RouteSettings(
              name: AppRoutes.reminder, arguments: Map()),
          builder: (context) => ReminderScreen()
      );

    case AppRoutes.workoutCompleteScreen:
      return MaterialPageRoute(
          settings: RouteSettings(
              name: AppRoutes.workoutCompleteScreen, arguments: Map()),
